...
```
フルコース:   dandori-spec → dandori-ground → dandori-review → (dandori-spike) → dandori-plan → dandori-impl → dandori-codereview → dandori-gate
...
phase: review                     # spec | ground | review | spike | plan | impl | codereview | gate | done
