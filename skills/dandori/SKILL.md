...
```
フルコース:   dandori-spec → (dandori-sketch) → dandori-ground → dandori-review → (dandori-spike) → dandori-plan → dandori-impl → dandori-codereview → dandori-refine → dandori-gate
...
phase: review                     # spec | sketch | ground | review | spike | plan | impl | codereview | refine | gate | done
